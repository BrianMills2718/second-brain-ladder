...
export const ASSESSMENTS: AssessmentTask[] = [
  T({
    ...
    requiredConcepts: ["triple", "ontology", "subclass", "entailment", "rdf-graph", "property-graph"],
  ...
  T({
    ...
    requiredConcepts: ["propose-verify", "ontology-grounded-extraction", "shacl-validation", "provenance", "entity-resolution"],

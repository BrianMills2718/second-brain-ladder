...
const CONCEPTS: Concept[] = [
  ...
  { id: "disjointness", term: "disjointness", layer: "schema", band: "foundations",
    ...
    prerequisites: ["class", "axiom"], introducedIn: "sb-onto" },
  { id: "subproperty", term: "subproperty", layer: "schema", band: "foundations",
    ...
    prerequisites: ["property-schema"], introducedIn: "sb-onto" },
  { id: "equivalence", term: "equivalence", layer: "schema", band: "practitioner",
    ...
    prerequisites: ["subclass"], introducedIn: "sb-onto" },
  ...
  { id: "existential-restriction", term: "existential restriction", layer: "logic", band: "practitioner",
    ...
    prerequisites: ["class", "property-schema"], introducedIn: "sb-reasoning" },
  { id: "universal-restriction", term: "universal restriction", layer: "logic", band: "practitioner",
    ...
    prerequisites: ["class", "property-schema", "open-world-assumption"], introducedIn: "sb-reasoning" },
  { id: "defined-class", term: "defined class", layer: "logic", band: "practitioner",
    ...
    prerequisites: ["equivalence", "existential-restriction", "reasoner"], introducedIn: "sb-reasoning" },
  ...
  { id: "shacl-validation", term: "SHACL validation", layer: "system", band: "foundations",
    short: "@c{validation} of extracted data against shape constraints — the verify step that catches bad @c{llm-extraction}. It *reports* violations; core SHACL doesn't derive facts (the SHACL-AF rules extension can).",

...
const CONCEPTS: Concept[] = [
  ...
  { id: "functional-property", term: "functional property", layer: "logic", band: "practitioner",
    short: "A @c{cardinality-restriction} of at-most-one: a @c{property-schema} with a single value, so two *distinct* values are a @c{consistency} violation.",
    example: "`hasBirthYear` functional: asserting both 1815 and 1816 for one person is inconsistent.",
...
export const PREREQ_WHY: Record<string, string> = {
  ...
  "functional-property>consistency": "two distinct values violate consistency",

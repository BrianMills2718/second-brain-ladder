...
const CONCEPTS: Concept[] = [
  ...
  { id: "entity", term: "entity", layer: "data", primitive: true,
    ...
    prerequisites: [], contrasts: ["class"], introducedIn: "sb-kg",
  ...
  { id: "entailment", term: "entailment", layer: "logic",
    ...
    prerequisites: ["triple", "ontology", "axiom"], contrasts: ["hallucination"], introducedIn: "sb-reasoning",
  ...
  { id: "consistency", term: "consistency", layer: "logic",
    ...
    prerequisites: ["reasoner", "axiom"], introducedIn: "sb-reasoning" },
  ...
  { id: "rule", term: "rule (SHACL/SWRL)", layer: "logic",
    short: "An if-then constraint or production over @c{triple}s and the @c{ontology} — shapes to validate, or rules to derive.",
    example: "SHACL: every `Note` must have a `title`.",
    prerequisites: ["triple", "ontology"], introducedIn: "sb-reasoning" },
  ...
  { id: "neurosymbolic", term: "neurosymbolic", layer: "system",
    ...
    example: "LLM drafts triples; the reasoner rejects the ill-typed ones.",
  ...
  { id: "shacl-validation", term: "SHACL validation", layer: "system",
    short: "Validating extracted data against @c{rule}-style shapes — the verify step that catches bad @c{llm-extraction}.",
    example: "Reject any `Note` missing a `title`.",
    prerequisites: ["rule", "llm-extraction"], introducedIn: "sb-neurosymbolic" },
  { id: "propose-verify", term: "propose & verify", layer: "system",
    short: "The neurosymbolic loop: @c{llm-extraction} proposes, the @c{reasoner} (and shapes) verify — the heart of @c{neurosymbolic} for a trustworthy brain.",
    example: "Draft → validate → accept/repair → store.",
    prerequisites: ["llm-extraction", "reasoner", "neurosymbolic"], introducedIn: "sb-neurosymbolic" },
...
export const PREREQ_WHY: Record<string, string> = {
  ...
  "shacl-validation>rule": "SHACL shapes are rules",
  ...
  "propose-verify>reasoner": "the verify step uses the reasoner",
